const projects = [
  {
    ...
    files: [
      { name: "Zain Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "Zain Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "Zain Logo.Zip", size: "2.02 MB", link: "#" },
      { name: "Zain admin.Zip", size: "2.25 MB", link: "#" },
    ],
    comments: [
      {
        id: 1,
